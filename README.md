...
3. Scrolling can be at times faulty as the feed on Nextdoor is not arranged solely by post date, but also other factors. Some older posts can appear in between newer posts, which may stop your scrolling processes. 