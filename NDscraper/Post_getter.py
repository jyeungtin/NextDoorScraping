def find_post_information():
    ...
    for i in range(len(post_grid)):
        try: 
            ...
            temp_reaction_count = get_reaction(post_grid[i])
            ...
            pass
    return post, text, neighbourhood_name, post_username, reaction_count, post_date, comment_count